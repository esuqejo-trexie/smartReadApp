...
const teacherAvatars = [
  require("../../assets/images/teach_avatar1.png"),
  require("../../assets/images/teach_avatar2.png"),
  require("../../assets/images/teach_avatar3.png"),
];
...
export default function ProfileScreen() {
  ...
  const [nickname, setNickname] = useState("Ms. Carla");
  const [email, setEmail] = useState("ms.carla@example.com");
  ...
  const handleLogout = () => {
    Alert.alert("Confirm Logout", "Are you sure you want to log out?", [
      { text: "Cancel", style: "cancel" },
      {
        ...
        style: "destructive",
        onPress: () => {
          router.push("/signup"); // Redirects to app/signup.tsx
        },
      },
    ]);
  };
      ...
      >
        ...
        >
          <View className="flex-1 justify-center items-center px-4 py-8 space-y-6">
              ...
              <View className="flex-row items-center mb-4">
                ...
                <View className="ml-4 flex-1">
                  {isEditing ? (
                    ...
                    <>
                      <Text className="text-2xl font-sans-bold text-purple-700">
                        {nickname}
                      </Text>
            ...
            {/* Class Summary */}
            <View className="bg-white w-full max-w-md rounded-2xl px-6 py-4 shadow-md border border-purple-200 mt-5">
              <Text className="text-lg font-sans-bold text-purple-700 mb-3">
                Class Summary
              </Text>
              <View className="flex-row justify-between">
                <Text className="text-gray-700">Total Students</Text>
                <Text className="text-indigo-600 font-sans-bold">25</Text>
              </View>
              <View className="flex-row justify-between mt-2">
                <Text className="text-gray-700">Active Sessions</Text>
                <Text className="text-indigo-600 font-sans-bold">12</Text>
              </View>
            </View>
